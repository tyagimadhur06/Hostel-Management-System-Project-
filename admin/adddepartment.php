...
<body>
			...
			<form>
				<div class="contain">
							<div class="user_fields">
								...
								<input type="dame" name="dname" id="dname" class="form-control" placeholder="Enter student's Department">
							</div>
							<div class="col-sm-12">
								<div class="col-sm-3"></div>
							<div class="col-sm-6 submit_btn">
								<button type="submit" name="Submit" id="submit" onclick="adddept();">Submit</button>
							</div>
							<div class="col-sm-3"></div>
						</div>
				    </div>
	...
	<script type="text/javascript">
		...
		function adddept()
		{
			...
			alert(dname);
			var token='<?php echo password_hash("department", PASSWORD_DEFAULT);?>';
			if(dname!="")
			{
				$.ajax(
				{
