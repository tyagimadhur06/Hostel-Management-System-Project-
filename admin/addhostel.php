...
<body>
			...
			<form>
				<div class="contain">
							<div class="user_fields">
								...
								<input type="name" name="hname" id="hname" class="form-control" placeholder="Enter student's Hostel">
							</div>
							<div class="col-sm-12">
								<div class="col-sm-3"></div>
							<div class="col-sm-6 submit_btn">
								<button type="submit" name="Submit" id="submit" onclick="addhostel();">Submit</button>
							</div>
							<div class="col-sm-3"></div>
						</div>
				    </div>
	...
	<script type="text/javascript">
		...
		function addhostel()
		{
			...
			alert(hname);
			var token='<?php echo password_hash("hostel", PASSWORD_DEFAULT);?>';
			if(hname!="")
			{
				$.ajax(
				{
					type:'POST',
					url:"ajax/addhostel.php",
					data:{hname:hname,token:token},
