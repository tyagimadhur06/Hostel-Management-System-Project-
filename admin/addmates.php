...
<body>
			...
			<form>
				<div class="contain">
							<div class="user_fields">
								...
								<input type="name" name="input" id="input" class="form-control" placeholder="Enter Room Number">
							</div>
							<div class="col-sm-12">
								<div class="col-sm-3"></div>
							<div class="col-sm-6 submit_btn">
								<button type="submit" name="Submit" id="submit" onclick="getmates();">Submit</button>
							</div>
							<div class="col-sm-3"></div>
						</div>
				    </div>
				    <div>
				    	<div class="mateslist" id="mateslist" style="color: black; margin-top: 20px; width: 100%; float:left;"></div>
				    </div>
			</form>				
			</div>
				<div class="col-sm-4"></div>
	...
	<script type="text/javascript">
		...
		function getmates()
		{
			...
			var token='<?php echo password_hash("getmates", PASSWORD_DEFAULT);?>';
			
				$.ajax(
				{
					type:'POST',
					url:"ajax/getmates.php",
					data:{input:input,token:token},
